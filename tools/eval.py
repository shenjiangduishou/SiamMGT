...
from toolkit.visualization.draw_radar import radar_map
...
parser.add_argument('--draw_radar','-dr',dest='draw_radar', action='store_true')
...
def main():
    ...
    if 'OTB' in args.dataset:
        ...
        benchmark = EAOBenchmark(dataset,tags=['all', 'camera_motion', 'illum_change', 'motion_change',
