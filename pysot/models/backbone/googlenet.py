...
class Inception3(nn.Module):
    ...
    def __init__(self, transform_input=False):
        ...
        # self.hspa_z = TrackingHSPA(768,reduction=3, res_scale=0.5)
        # self.hspa_x = TrackingHSPA(768,reduction=3, res_scale=0.5)
        # self.downsample = FeatureDownsample(768) #HW从33到25
...
class FeatureDownsample(nn.Module):
    def __init__(self, in_channels):
        super().__init__()
        self.downsample = nn.Sequential(
            # 第一层5×5卷积
            nn.Conv2d(in_channels, in_channels, kernel_size=5, stride=1, padding=0, bias=False),
