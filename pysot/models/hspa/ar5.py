...
class Graph_Attention_Union_ar(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        # self.hspa = DepthwiseSeparableConvWithWTConv2d(2*in_channel,out_channel)
...
if __name__ == '__main__':
    input = torch.randn(3, 32, 13, 13)  # b c h w输入
    input2 = torch.randn(3, 32, 25, 25)  # b c h w输入
    wtconv = Graph_Attention_Union_ar(in_channel=32, out_channel=32)
