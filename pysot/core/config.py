...
__C.DATASET.VID.ANNO = '/PATH/TO/VID/train.json'
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = '/PATH/TO/YTBB'
__C.DATASET.YOUTUBEBB.ANNO = '/PATH/TO/YTBB/train.json'
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = 200000

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/PATH/TO/COCO'
__C.DATASET.COCO.ANNO = '/PATH/TO/COCO/train2017.json'
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = 50000

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = '/PATH/TO/DET'
__C.DATASET.DET.ANNO = '/PATH/TO/DET/train.json'
__C.DATASET.DET.FRAME_RANGE = 1
__C.DATASET.DET.NUM_USE = 50000

__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = r'D:\pycharm\progress\SiamCAR-master\train_dataset\got10k\crop511\vehicle'
__C.DATASET.GOT.ANNO = r'D:\pycharm\progress\SiamCAR-master\train_dataset\got10k\crop511\vehicle\train.json'
__C.DATASET.GOT.FRAME_RANGE = 50
__C.DATASET.GOT.NUM_USE = 200000

__C.DATASET.LaSOT = CN()
__C.DATASET.LaSOT.ROOT = '/PATH/TO/LaSOT'
__C.DATASET.LaSOT.ANNO = '/PATH/TO/LaSOT/train.json'
...
__C.DATASET.TrackingNet.ANNO = '/PATH/TO/TrackingNet/train.json'
...
__C.HP_SEARCH.OTB100 = [0.4, 0.15, 0.45]

# __C.HP_SEARCH.OTB100 = [0.32, 0.3, 0.38]

__C.HP_SEARCH.GOT_10k = [0.7, 0.04, 0.35]

# __C.HP_SEARCH.GOT_10k = [0.9, 0.25, 0.35]

__C.HP_SEARCH.UAV123 = [0.2, 0.01, 0.11]

__C.HP_SEARCH.LaSOT = [0.3, 0.01, 0.18]
